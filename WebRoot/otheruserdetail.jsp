...
<%
	...
	boolean isLike = userRel.checkisLike(loginid, userid);
...
<div class="container">
  ...
  <div class="text-center">
  	<% if(isLike) {%>
    <a href="dislikedeal?userid=<%= userid %>" class="btn btn-primary" role="button">取消关注</a>
    <% } else { %>
    <a href="likedeal?userid=<%= userid %>" class="btn btn-primary" role="button">关注</a>
    <%} %>
  </div>  
</div>
...
<div class="container col-xs-8 col-xs-offset-2">
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h3 class="panel-title"><a href="#"><%= DB.getNickName(mb.getUserid()) %></a>说：</h3>
		</div>
